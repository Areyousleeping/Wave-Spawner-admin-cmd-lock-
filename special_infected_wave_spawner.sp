...
public OnPluginStart() {
	...
	// Console commands
	RegAdminCmd("sm_limit", Cmd_SetLimit, ADMFLAG_ROOT, "Set individual or total SI limits");
	RegAdminCmd("sm_waveinterval", Cmd_SetWaveInterval, ADMFLAG_ROOT, "Set the interval between waves");
	RegAdminCmd("sm_supportpercent", Cmd_SetTankSupportHealthPercent, ADMFLAG_ROOT, "Set the percentage of tank health at which support wave will spawn");
}
